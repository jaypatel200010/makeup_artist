                ...
                <div className="col-lg-5 w3l-video-info-right ps-lg-5 mt-lg-0 mt-5">
                  <div className="title-content-two">
                    ...
                    <p className="mt-2">
                      ...
                      amet elit. Velit beatae rem ullam dolore nisi esse
                      ...
                      <div className="testimonial-content">
                        <div className="testimonial">
                          ...
                          <blockquote>
                            ...
                            felis vitae facere aperiam sequi optio lacinia id
                            ipsum non velit, culpa. voluptate rem ullam dolore
                            nisi est quasi, doloribus tempora.
                          </blockquote>
                  ...
                  <div className="col-lg-7">
                    <div className="bottom-info">
                      <div className="header-section title-content-two pe-lg-5">
                        <h5 className="title-subw3hny mb-3">
                          Our Special Offer
                        </h5>
                  ...
                  <div className="subscribe mx-auto">
                    <div className="header-section text-center mx-auto">
                      ...
                      <p className="my-3 px-lg-5">
                        ...
                        and our products because they know we’re the best.
                      </p>
                    </div>
                    <form
                      action="#"
